...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Log.v("Sunshine.options", "Reached Item Selected Method");
        switch(item.getItemId()){
            case(R.id.action_refresh):
                Log.v("Sunshine.options", "Matched refresh id");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] data = {
                "Today - Sunny 20/21",
                "Tomorrow - Rainy 17/18",
                "Friday - Cloudy 17/18",
                "Saturday - Sunny 23/24"
        };

        List<String> forecastList = new ArrayList<String>(Arrays.asList(data));

        forecastAdapter = new ArrayAdapter<String>(getActivity(), R.layout.list_item_forecast, R.id.list_item_forecast_textview, forecastList);
